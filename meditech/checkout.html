...
<head>
<meta charset="utf-8">
<title>Medi-tech - HTML Template | Shop</title>
<!-- Stylesheets -->
    ...
    <div class="checkout-page">
    	<div class="auto-container">
                ...
                <div class="coupon-form">
                    <form method="post" action="contact.html">
                        <div class="row clearfix">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                <button class="theme-btn btn-style-one" type="submit" name="submit-form"><span class="txt">apply coupon</span></button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="order-box">
                ...
                <ul>
                	<li class="clearfix"><strong>Patient Ninjas <i class="fa fa-times"></i> 1</strong><span>$35.00</span></li>
